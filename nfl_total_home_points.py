# -*- coding: utf-8 -*-
"""
Created on Fri Oct  7 17:14:55 2022
...
root= tk.Tk()
root.title("Random Forest Using DVOA -- Predicting Home Team Points")
...
button1 = tk.Button (root, text='      Predict spread      ',command=values, bg='purple', fg='white', font=11)
